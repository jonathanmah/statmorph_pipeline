...
def statmorphWrapper(index_pairs):
    ...
    # These galaxies have an original file size of over 250MB. These are just a testing set.
    sampleListBigFileGalaxies = ['NGVSJ12:28:03.88+09:48:13.4', 'NGVSJ12:28:43.31+11:45:18.1', 'NGVSJ12:28:57.56+13:14:31.0', 'NGVSJ12:29:00.04+13:58:42.5', 'NGVSJ12:29:21.29+08:09:23.8',
        'NGVSJ12:29:48.87+13:25:46.0', 'NGVSJ12:29:53.55+14:04:06.9', 'NGVSJ12:30:10.33+10:46:46.2', 'NGVSJ12:30:49.42+12:23:28.0','NGVSJ12:32:14.22+10:15:05.3', 'NGVSJ12:34:02.98+07:41:57.5', 
        'NGVSJ12:34:06.08+11:19:16.5', 'NGVSJ12:35:30.58+12:13:14.7', 'NGVSJ12:35:37.95+12:15:50.4','NGVSJ12:35:39.81+12:33:22.9', 'NGVSJ12:36:26.98+11:26:21.2', 'NGVSJ12:36:53.38+07:14:47.7', 
        'NGVSJ12:36:54.86+12:31:12.5', 'NGVSJ12:37:30.56+09:33:18.4', 'NGVSJ12:41:32.75+07:18:53.6', 'NGVSJ12:42:02.26+11:38:49.0', 'NGVSJ12:42:47.43+11:26:33.0', 'NGVSJ12:43:39.97+11:33:09.7', 
        'NGVSJ12:44:31.98+11:11:25.8', 'NGVSJ12:52:17.50+11:18:49.9', 'NGVSJ12:52:55.97+11:13:51.5'
    ]
    
    crashed = ['NGVSJ12:52:17.50+11:18:49.9']

    sampleList = ['NGVSJ12:34:06.08+11:19:16.5', 'NGVSJ12:52:17.50+11:18:49.9', 'NGVSJ12:28:43.31+11:45:18.1', 'NGVSJ12:29:53.55+14:04:06.9', 'NGVSJ12:35:30.58+12:13:14.7', 
    ...
    for row in df.iloc[index_pairs[0]:index_pairs[1]].itertuples(index=True, name='Pandas'):
        ...
        # UNCOMMENT TO KEEP TRACK OF GALAXIES WITH FILE SIZE GREATER THAN 300MB
        #---------------------------------------------------------------------------------------
        ...
        fig.savefig(f'/mnt/scratch/output/{galaxy}_sourcemorph:{round(end_time, 2)}_seg={round(endseg, 2)}_REfactor=10_mag={round(row.principleg_mag_cg, 3)}.png', facecolor='w', edgecolor='w', transparent=False, bbox_inches='tight')
        plt.close(fig)
        ...
        os.system(f'vcp /mnt/scratch/output/{galaxy}_sourcemorph:{round(end_time, 2)}_seg={round(endseg, 2)}_REfactor=10_mag={round(row.principleg_mag_cg, 3)}.png \
        vos:ngvs/data/STATMORPH/RE_factor_output/{galaxy}_sourcemorph:{round(end_time, 2)}_seg={round(endseg, 2)}_REfactor=10_mag={round(row.principleg_mag_cg, 3)}.png')
        if path.isfile(f'/mnt/scratch/output/{galaxy}_sourcemorph:{round(end_time, 2)}_seg={round(endseg, 2)}_REfactor=10_mag={round(row.principleg_mag_cg, 3)}.png'):
            os.system(f'rm /mnt/scratch/output/{galaxy}_sourcemorph:{round(end_time, 2)}_seg={round(endseg, 2)}_REfactor=10_mag={round(row.principleg_mag_cg, 3)}.png')
